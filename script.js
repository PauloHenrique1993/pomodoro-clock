document.addEventListener("DOMContentLoaded", () => {
   ...
   const progressBar = new ProgressBar.Circle("#pomodoro-timer", {
    ...
    const stepDown = () => {
      if (currentTimeLeftInSession > 0) {
        ...
        if (type === "Trabalho") {
          ...
          displaySessionLog("Trabalho");
          type = "Intervalo";
          setUpdatedTimers();
          // new
          currentTaskLabel.value = "Intervalo";
          ...
          setUpdatedTimers();
          // new
          if (currentTaskLabel.value === "Intervalo") {
            currentTaskLabel.value = workSessionLabel;
          }
          currentTaskLabel.disabled = false;
          displaySessionLog("Intervalo");
        }
      }
      displayCurrentTimeLeftInSession();
    };
    ...
    const displaySessionLog = type => {
      ...
      if (type === "Trabalho") {
        sessionLabel = currentTaskLabel.value ? currentTaskLabel.value : "Trabalho";
        workSessionLabel = sessionLabel;
      } else {
        sessionLabel = "Intervalo";
      }
    ...
    const calculateSessionProgress = () => {
      ...
      const sessionDuration =
        type === "Trabalho" ? workSessionDuration : breakSessionDuration;
